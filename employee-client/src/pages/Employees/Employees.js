...
var Employees = React.createClass({
	...
	onDeleteBtnClicked: function() {
		...
		axios.delete('http://localhost:8090/employees/' + this.state.selectedEmployeeId)
	...
	priceFormatter: function(cell, row){
		return '<i class="glyphicon glyphicon-yen"></i> ' + cell;
	},
	...
	getEmployees: function() {
	  return axios.get('http://localhost:8090/employees');
	},

	getDepartments: function() {
	  return axios.get('http://localhost:8090/departments');
	},
